  ...
  <VCard class="text-center text-sm-start">
    <VRow no-gutters>
      <VCol cols="12" sm="8" order="2" order-sm="1">
        <VCardItem>
          <VCardTitle class="text-md-h5 text-primary"> Contacts Management </VCardTitle>
        </VCardItem>

        <VCardText>
          <span>
            Manage all contacts and groups from here.
            <br />
            Create and contacts to groups.
          </span>
          <br />
          <VBtn variant="tonal" class="mt-4" size="small"> Contacts Area </VBtn>
        </VCardText>
      </VCol>
