...
const props = defineProps(["componentSource", "groupId" ]);
const emits = defineEmits(["uploadContactFile"]);

const componentSource = props.componentSource;
      ...
      <VForm @submit.prevent="submitForm">
        <VCardText>
          <VContainer>
            <VRow>
              <VCol cols="12">
                <div v-if="!formData.contacts_file">
        ...
        <VCardActions>
          ...
          <div v-if="componentSource == 'groupDetail'">
            <CustomLoader
              v-if="contactStore.formProcessing"
              style="height: 50; width: 50"
            />
            <VBtn type="submit" v-else>Import Group Contact</VBtn>
          </div>
        </VCardActions>
      </VForm>
    </VCard>
