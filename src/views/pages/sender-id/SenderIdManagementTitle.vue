  ...
  <VCard class="text-center text-sm-start">
    <VRow no-gutters>
      <VCol cols="12" sm="8" order="2" order-sm="1">
        <VCardItem>
          <VCardTitle class="text-md-h5 text-primary"> Sender ID Management </VCardTitle>
        </VCardItem>

        <VCardText>
          <span>
            Manage your sender ids from here.
            <br />
            Add, edit or remove sender ids from your account.
          </span>
          <br />
          <VBtn variant="tonal" class="mt-4" size="small"> Sender IDs </VBtn>
        </VCardText>
      </VCol>
