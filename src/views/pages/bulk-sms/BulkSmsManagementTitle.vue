  ...
  <VCard class="text-center text-sm-start">
    <VRow no-gutters>
      <VCol cols="12" sm="8" order="2" order-sm="1">
        <VCardItem>
          <VCardTitle class="text-md-h5 text-primary"> SMS Management </VCardTitle>
        </VCardItem>

        <VCardText>
          <span>
            Monitor sms usage from here.
            <br />
            Create and send sms messages to your contacts and/or groups
          </span>
          <br />
          <VBtn variant="tonal" class="mt-4" size="small"> SMS Stats </VBtn>
        </VCardText>
      </VCol>
