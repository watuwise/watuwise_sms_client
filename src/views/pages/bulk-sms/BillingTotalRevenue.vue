...
import BillingMoreBtn from "./BillingMoreBtn.vue";

const props = defineProps(["revenueStats", "businessYears"]);
    ...
    <VRow no-gutters>
      <VCol cols="12">
        <VCardItem class="pb-0">
          ...
          <template #append>
            <div class="me-n3">
              <BillingMoreBtn :menu-list="props.businessYears" />
            </div>
          </template>
        </VCardItem>
        ...
        <VueApexCharts
          ...
          :series="[{ name: 'Revenue', data: props.revenueStats }]"
        />
      </VCol>
    </VRow>
  </VCard>
