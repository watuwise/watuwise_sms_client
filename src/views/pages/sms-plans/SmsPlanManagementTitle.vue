  ...
  <VCard class="text-center text-sm-start">
    <VRow no-gutters>
      <VCol cols="12" sm="8" order="2" order-sm="1">
        <VCardItem>
          <VCardTitle class="text-md-h5 text-primary"> Sms Plans Management </VCardTitle>
        </VCardItem>

        <VCardText>
          <span>
            Manage client sms plans from here.
            <br />
            Add, edit or remove client sms plans from the system.
          </span>
          <br />
          <VBtn variant="tonal" class="mt-4" size="small"> Sms Plans </VBtn>
        </VCardText>
      </VCol>
